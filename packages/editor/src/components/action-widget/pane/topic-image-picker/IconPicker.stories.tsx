...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A picker component that allows users to select either emojis or icons from the Icons Gallery for topics.',
      },
    },
  },
};
...
export const WithInitialEmojiValue: Story = {
  render: () => {
    const emojiModel = new SimpleNodeProperty<string | undefined>('😀');
    const iconsGalleryModel = new SimpleNodeProperty<string | undefined>(undefined);
    return (
      <TopicImagePicker
        triggerClose={() => {}}
...
export const WithInitialIconValue: Story = {
  render: () => {
    const emojiModel = new SimpleNodeProperty<string | undefined>(undefined);
    const iconsGalleryModel = new SimpleNodeProperty<string | undefined>('Star');
    return (
      <TopicImagePicker
        triggerClose={() => {}}
        emojiModel={emojiModel}
