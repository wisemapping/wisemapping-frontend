...
const Designer = new Class(
    /** @lends Designer */ {
        ...
        initialize: function (options, divElement) {
            ...
            // Dispatcher manager ...
            var commandContext = new CommandContext(this);
            ...
            // Init Screen manager..
            var screenManager = new ScreenManager(divElement);
        ...
        addEvent: function (type, listener) {
            if (type == TopicEvent.EDIT || type == TopicEvent.CLICK) {
                var editor = TopicEventDispatcher.getInstance();
        ...
        _buildDragManager: function (workspace) {
            ...
            var dragConnector = new DragConnector(designerModel, this._workspace);
            var dragManager = new DragManager(workspace, this._eventBussDispatcher);
        ...
        _buildNodeGraph: function (model, readOnly) {
            // Create node graph ...
            var topic = NodeGraph.create(model, { readOnly: readOnly });
        ...
        loadMap: function (mindmapModel) {
            ...
            var layoutManager = new LayoutManager(mindmapModel.getCentralTopic().getId(), size);
            var me = this;
        ...
        _buildRelationshipShape: function (model) {
            ...
            $assert(
                ...
                'targetTopic could not be found:' +
                    targetTopicId +
                    dmodel.getTopics().map(function (e) {
                        return e.getId();
                    })
            );

            // Build relationship line ....
            var result = new Relationship(sourceTopic, targetTopic, model);
            var me = this;
