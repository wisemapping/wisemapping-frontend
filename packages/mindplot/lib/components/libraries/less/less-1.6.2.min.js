...
!(function (a, b) {
  function c(b) { return a.less[b.split('/')[1]]; } function d(a, b) { v.env == 'development' && typeof console !== 'undefined' && v.logLevel >= b && console.log(`less: ${a}`); } function e(a) {
    return a.replace(/^[a-z-]+:\/+?[^\/]+/, '').replace(/^\//, '').replace(/\.[a-zA-Z]+$/, '').replace(/[^\.\w-]+/g, '-')
      .replace(/\./g, ':');
  } function f(a, c) { const e = '{line} {content}'; const f = a.filename || c; const g = []; let h = `${a.type || 'Syntax'}Error: ${a.message || 'There is an error in your .less file'} in ${f} `; const i = function (a, c, d) { a.extract[c] !== b && g.push(e.replace(/\{line\}/, (parseInt(a.line, 10) || 0) + (c - 1)).replace(/\{class\}/, d).replace(/\{content\}/, a.extract[c])); }; a.extract ? (i(a, 0, ''), i(a, 1, 'line'), i(a, 2, ''), h += `on line ${a.line}, column ${a.column + 1}:\n${g.join('\n')}`) : a.stack && (h += a.stack), d(h, y.errors); } function g(a, b, c) { const f = b.href || ''; const g = `less:${b.title || e(f)}`; const h = document.getElementById(g); let i = !1; const j = document.createElement('style'); if (j.setAttribute('type', 'text/css'), b.media && j.setAttribute('media', b.media), j.id = g, j.styleSheet) try { j.styleSheet.cssText = a; } catch (k) { throw new Error("Couldn't reassign styleSheet.cssText."); } else j.appendChild(document.createTextNode(a)), i = h !== null && h.childNodes.length > 0 && j.childNodes.length > 0 && h.firstChild.nodeValue === j.firstChild.nodeValue; const l = document.getElementsByTagName('head')[0]; if (h === null || i === !1) { const m = b && b.nextSibling || null; m ? m.parentNode.insertBefore(j, m) : l.appendChild(j); } if (h && i === !1 && h.parentNode.removeChild(h), c && C) { d(`saving ${f} to cache.`, y.info); try { C.setItem(f, a), C.setItem(`${f}:timestamp`, c); } catch (k) { d('failed to save', y.errors); } } } function h(a, c) { let d; let f; const h = `less-error-message:${e(c || '')}`; const i = '<li><label>{line}</label><pre class="{class}">{content}</pre></li>'; const j = document.createElement('div'); const k = []; const l = a.filename || c; const m = l.match(/([^\/]+(\?.*)?)$/)[1]; j.id = h, j.className = 'less-error-message', f = `<h3>${a.type || 'Syntax'}Error: ${a.message || 'There is an error in your .less file'}</h3><p>in <a href="${l}">${m}</a> `; const n = function (a, c, d) { a.extract[c] !== b && k.push(i.replace(/\{line\}/, (parseInt(a.line, 10) || 0) + (c - 1)).replace(/\{class\}/, d).replace(/\{content\}/, a.extract[c])); }; a.extract ? (n(a, 0, ''), n(a, 1, 'line'), n(a, 2, ''), f += `on line ${a.line}, column ${a.column + 1}:</p><ul>${k.join('')}</ul>`) : a.stack && (f += `<br/>${a.stack.split('\n').slice(1).join('<br/>')}`), j.innerHTML = f, g(['.less-error-message ul, .less-error-message li {', 'list-style-type: none;', 'margin-right: 15px;', 'padding: 4px 0;', 'margin: 0;', '}', '.less-error-message label {', 'font-size: 12px;', 'margin-right: 15px;', 'padding: 4px 0;', 'color: #cc7777;', '}', '.less-error-message pre {', 'color: #dd6666;', 'padding: 4px 0;', 'margin: 0;', 'display: inline-block;', '}', '.less-error-message pre.line {', 'color: #ff0000;', '}', '.less-error-message h3 {', 'font-size: 20px;', 'font-weight: bold;', 'padding: 15px 0 5px 0;', 'margin: 0;', '}', '.less-error-message a {', 'color: #10a', '}', '.less-error-message .error {', 'color: red;', 'font-weight: bold;', 'padding-bottom: 2px;', 'border-bottom: 1px dashed red;', '}'].join('\n'), { title: 'error-message' }), j.style.cssText = ['font-family: Arial, sans-serif', 'border: 1px solid #e00', 'background-color: #eee', 'border-radius: 5px', '-webkit-border-radius: 5px', '-moz-border-radius: 5px', 'color: #e00', 'padding: 15px', 'margin-bottom: 15px'].join(';'), v.env == 'development' && (d = setInterval(() => { document.body && (document.getElementById(h) ? document.body.replaceChild(j, document.getElementById(h)) : document.body.insertBefore(j, document.body.firstChild), clearInterval(d)); }, 10)); } function i(a, b) { v.errorReporting && v.errorReporting !== 'html' ? v.errorReporting === 'console' ? f(a, b) : typeof v.errorReporting === 'function' && v.errorReporting('add', a, b) : h(a, b); } function j(a) { const b = document.getElementById(`less-error-message:${e(a)}`); b && b.parentNode.removeChild(b); } function k() {} function l(a) { v.errorReporting && v.errorReporting !== 'html' ? v.errorReporting === 'console' ? k(a) : typeof v.errorReporting === 'function' && v.errorReporting('remove', a) : j(a); } function m(a) { for (var b, c = document.getElementsByTagName('style'), d = 0; d < c.length; d++) if (b = c[d], b.type.match(B)) { const e = new v.tree.parseEnv(v); const f = b.innerHTML || ''; e.filename = document.location.href.replace(/#.*$/, ''), (a || v.globalVars) && (e.useFileCache = !0); const g = (function (a) { return function (b, c) { if (b) return i(b, 'inline'); const d = c.toCSS(v); a.type = 'text/css', a.styleSheet ? a.styleSheet.cssText = d : a.innerHTML = d; }; }(b)); new v.Parser(e).parse(f, g, { globalVars: v.globalVars, modifyVars: a }); } } function n(a, b) { let c; let d; const e = /^((?:[a-z-]+:)?\/+?(?:[^\/\?#]*\/)|([\/\\]))?((?:[^\/\\\?#]*[\/\\])*)([^\/\\\?#]*)([#\?].*)?$/i; const f = a.match(e); const g = {}; let h = []; if (!f) throw new Error(`Could not parse sheet href - '${a}'`); if (!f[1] || f[2]) { if (d = b.match(e), !d) throw new Error(`Could not parse page url - '${b}'`); f[1] = f[1] || d[1] || '', f[2] || (f[3] = d[3] + f[3]); } if (f[3]) { for (h = f[3].replace(/\\/g, '/').split('/'), c = 0; c < h.length; c++)h[c] === '.' && (h.splice(c, 1), c -= 1); for (c = 0; c < h.length; c++)h[c] === '..' && c > 0 && (h.splice(c - 1, 2), c -= 2); } return g.hostPart = f[1], g.directories = h, g.path = f[1] + h.join('/'), g.fileUrl = g.path + (f[4] || ''), g.url = g.fileUrl + (f[5] || ''), g; } function o(a, b) { let c; let d; let e; let f; const g = n(a); const h = n(b); let i = ''; if (g.hostPart !== h.hostPart) return ''; for (d = Math.max(h.directories.length, g.directories.length), c = 0; d > c && h.directories[c] === g.directories[c]; c++);for (f = h.directories.slice(c), e = g.directories.slice(c), c = 0; c < f.length - 1; c++)i += '../'; for (c = 0; c < e.length - 1; c++)i += `${e[c]}/`; return i; } function p() { if (a.XMLHttpRequest) return new XMLHttpRequest(); try { return new ActiveXObject('MSXML2.XMLHTTP.3.0'); } catch (b) { return d("browser doesn't support AJAX.", y.errors), null; } } function q(a, b, c, e) { function f(b, c, d) { b.status >= 200 && b.status < 300 ? c(b.responseText, b.getResponseHeader('Last-Modified')) : typeof d === 'function' && d(b.status, a); } const g = p(); const h = x ? v.fileAsync : v.async; typeof g.overrideMimeType === 'function' && g.overrideMimeType('text/css'), d(`XHR: Getting '${a}'`, y.info), g.open('GET', a, h), g.setRequestHeader('Accept', b || 'text/x-less, text/css; q=0.9, */*; q=0.5'), g.send(null), x && !v.fileAsync ? g.status === 0 || g.status >= 200 && g.status < 300 ? c(g.responseText) : e(g.status, a) : h ? g.onreadystatechange = function () { g.readyState == 4 && f(g, c, e); } : f(g, c, e); } function r(b, c, d, e) { c && c.currentDirectory && !/^([a-z-]+:)?\//.test(b) && (b = c.currentDirectory + b); const f = n(b, a.location.href); const g = f.url; const h = { currentDirectory: f.path, filename: g }; if (c ? (h.entryPath = c.entryPath, h.rootpath = c.rootpath, h.rootFilename = c.rootFilename, h.relativeUrls = c.relativeUrls) : (h.entryPath = f.path, h.rootpath = v.rootpath || f.path, h.rootFilename = g, h.relativeUrls = e.relativeUrls), h.relativeUrls && (h.rootpath = e.rootpath ? n(e.rootpath + o(f.path, h.entryPath)).path : f.path), e.useFileCache && D[g]) try { const i = D[g]; d(null, i, g, h, { lastModified: new Date() }); } catch (j) { d(j, null, g); } else q(g, e.mime, (a, b) => { D[g] = a; try { d(null, a, g, h, { lastModified: b }); } catch (c) { d(c, null, g); } }, (a, b) => { d({ type: 'File', message: `'${b}' wasn't found (${a})` }, null, g); }); } function s(a, b, c, d, e) { const f = new v.tree.parseEnv(v); f.mime = a.type, (e || v.globalVars) && (f.useFileCache = !0), r(a.href, null, (h, i, j, k, m) => { if (m) { m.remaining = d; const n = C && C.getItem(j); const o = C && C.getItem(`${j}:timestamp`); if (!c && o && m.lastModified && new Date(m.lastModified).valueOf() === new Date(o).valueOf()) return g(n, a), m.local = !0, b(null, null, i, a, m, j), void 0; }l(j), i ? (f.currentFileInfo = k, new v.Parser(f).parse(i, (c, d) => { if (c) return b(c, null, null, a); try { b(c, d, i, a, m, j); } catch (c) { b(c, null, null, a); } }, { modifyVars: e, globalVars: v.globalVars })) : b(h, null, null, a, m, j); }, f, e); } function t(a, b, c) { for (let d = 0; d < v.sheets.length; d++)s(v.sheets[d], a, b, v.sheets.length - (d + 1), c); } function u() { v.env === 'development' ? (v.optimization = 0, v.watchTimer = setInterval(() => { v.watchMode && t((a, b, c, d, e) => { a ? i(a, d.href) : b && g(b.toCSS(v), d, e.lastModified); }); }, v.poll)) : v.optimization = 3; }(typeof a.less === 'undefined' || typeof a.less.nodeType !== 'undefined') && (a.less = {}), v = a.less, w = a.less.tree = {}, v.mode = 'browser'; let v; let w; v === b && (v = exports, w = c('./tree'), v.mode = 'node'), v.Parser = function (a) {
    ...
    function e(a, b, c) { if (!(c instanceof d.Dimension)) throw { type: 'Argument', message: 'argument must be a number' }; return b == null ? b = c.unit : c = c.unify(), new d.Dimension(a(parseFloat(c.value)), b); } function f(a, b, c) { let e; let f; let g; let h; const i = b.alpha; const j = c.alpha; const k = []; g = j + i * (1 - j); for (let l = 0; l < 3; l++)e = b.rgb[l] / 255, f = c.rgb[l] / 255, h = a(e, f), g && (h = (j * f + i * (e - j * (e + f - h))) / g), k[l] = 255 * h; return new d.Color(k, g); } function g() { let a; const b = d.functions; for (a in l)l.hasOwnProperty(a) && (b[a] = e.bind(null, Math[a], l[a])); for (a in m)m.hasOwnProperty(a) && (b[a] = f.bind(null, m[a])); a = d.defaultFunc, b.default = a.eval.bind(a); } function h(a) { return d.functions.hsla(a.h, a.s, a.l, a.a); } function i(a, b) { return a instanceof d.Dimension && a.unit.is('%') ? parseFloat(a.value * b / 100) : j(a); } function j(a) { if (a instanceof d.Dimension) return parseFloat(a.unit.is('%') ? a.value / 100 : a.value); if (typeof a === 'number') return a; throw { error: 'RuntimeError', message: 'color functions take numbers as parameters' }; } function k(a) { return Math.min(1, Math.max(0, a)); }d.functions = {
      ...
      eval() { const a = this.value_; const b = this.error_; if (b) throw b; return a != null ? a ? d.True : d.False : void 0; }, value(a) { this.value_ = a; }, error(a) { this.error_ = a; }, reset() { this.value_ = this.error_ = null; },
    ...
    a.Extend = function (b, c, d) { switch (this.selector = b, this.option = c, this.index = d, this.object_id = a.Extend.next_id++, this.parent_ids = [this.object_id], c) { case 'all': this.allowBefore = !0, this.allowAfter = !0; break; default: this.allowBefore = !1, this.allowAfter = !1; } }, a.Extend.next_id = 0, a.Extend.prototype = {
