 ...
 */
  ...
  jQuery.extend({
    ...
    cleanData(elems) {
      let data; let elem; let events; let type; let key; let j;
 ...
 */
  ...
  (function () {
    ...
    const divReset = 'padding:0;margin:0;border:0;display:block;-webkit-box-sizing:content-box;'
  ...
  function defaultPrefilter(elem, props, opts) {
    ...
    let prop; let value; let toggle; let tween; let hooks; let oldfire; let display;
    const anim = this;
    const orig = {};
    const { style } = elem;
